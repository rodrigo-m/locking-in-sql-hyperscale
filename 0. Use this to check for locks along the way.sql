...
/* If you are running in a shared environment, uncomment the last line with the AND statement and     */
/*   fill in the parenthesis with your session ids                                                    */
SELECT resource_type, resource_associated_entity_id,
  request_status, request_mode,request_session_id,
  resource_description
  FROM sys.dm_tran_locks
  where resource_type <> 'DATABASE'
  -- and request_session_id IN (85, 97, 122)
